...
public class TaskControllerTest extends BasicTestClass {
    ...
    void successfulGetTasksTest() {
        taskService.createTask(
                createdProjectId,
                createdColumnId,
                new TaskDto(null, TASK_NAME + "1", null, null, null, null)
        );

        taskService.createTask(
                createdProjectId,
                createdColumnId,
                new TaskDto(null, TASK_NAME + "2", null, null, null, null)
        );
    ...
    void successfulCreateOfTaskTest() {
        TaskDto taskDto = new TaskDto(null, TASK_NAME, null, null, null, null);
    ...
    void successfulEditOfTaskTest() {
        TaskDto createTaskDto = new TaskDto(null, TASK_NAME, null, null, null, null);
        ...
        TaskDto editTaskDto = new TaskDto(null, newTaskName, null, null, null, null);
