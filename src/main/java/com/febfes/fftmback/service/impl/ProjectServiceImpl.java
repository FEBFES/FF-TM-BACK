...
//import com.febfes.fftmback.service.project.patch.ProjectPatchIsFavouriteProcessor;
...
//
//    private final ProjectPatchFieldProcessor patchIsFavouriteProcessor = new ProjectPatchIsFavouriteProcessor(this, null);
//
//    @Override
...
//        CompletableFuture.runAsync(() -> addOrChangeProjectMemberRole(projectId, userId, RoleName.OWNER));
